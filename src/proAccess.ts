// src/proAccess.ts
// Fail-open Pro gate for Dreamfeed. Pro = the $14.99 one-time pediatrician-PDF unlock
// (and future extras: multi-baby, charts). The record-keeping stays free forever.
//
